...
class ICustomerRepositoryTestWithContainer {
    @Container
    @ServiceConnection
    ...
    @Test //cette methode permet de tester que la connection avec le container est bien établie
    public void connectionEtablishedTest(){
        assertThat(postgreSQLContainer.isCreated()).isTrue();//verifie si le container est créé
        assertThat(postgreSQLContainer.isRunning()).isTrue();//vérifie si le container est demarré
    }
